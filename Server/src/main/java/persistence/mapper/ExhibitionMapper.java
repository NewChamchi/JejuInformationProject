...
public interface ExhibitionMapper {
    ...
    @Select("SELECT * FROM EXHIBITION " +
            ...
            "WHERE SPOT_KEY = EXHIBITION.SPOT_KEY AND SPOT_ADDRESS LIKE CONCAT ('%', #{address}, '%')) ")
    ...
    @Select("SELECT * FROM SPOT_INFORMATION " +
            ...
            "WHERE SPOT_KEY = SPOT_INFORMATION.SPOT_KEY AND SPOT_INFORMATION.SPOT_ADDRESS LIKE CONCAT ('%', #{address}, '%')) ")
